...
###Weighted model - Lasso and Ridge
```{r}
...
##Weighted model - Boost and Lasso
```{r}
Weighted_model2 <- data.frame(Id = Id_labels, SalePrice = (prediction_boost+prediction_ridge+2*prediction_lasso)/4)
write.csv(Weighted_model2, file = 'prediction13.csv', row.names = F)
```
*0.11961 from Kaggle*
